        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-purple-100 mb-6 max-w-md">
              ...
              Join our community and give new life to your belongings.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/add-item" className="text-purple-200 hover:text-white transition-colors">
                  Add Item
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/safety" className="text-purple-200 hover:text-white transition-colors">
                  Safety Tips
                </Link>
              </li>
              <li>
