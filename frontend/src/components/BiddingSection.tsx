    ...
    <section className="py-12 bg-white">
      <div className="container">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-8">
          ...
          <Link 
            href="/bidding"
            className="btn bg-orange-600 hover:bg-orange-700 text-white px-6 py-3 rounded-lg font-medium transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
          >
            View All Auctions
          </Link>
        </div>
        ...
        <div className="text-center mt-8">
          <Link
            href="/bidding"
            className="btn border-2 border-orange-600 text-orange-600 hover:bg-orange-600 hover:text-white px-8 py-3 rounded-lg font-medium transition-all duration-300 transform hover:scale-105"
          >
            View All Auctions
          </Link>
        </div>
