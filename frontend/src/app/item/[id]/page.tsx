...
export default function ItemDetailPage() {
  ...
  useEffect(() => {
    ...
    const fetchItem = async () => {
      try {
        ...
        // Handle both item and { item } responses
  ...
  const handleChatWithSeller = () => {
    ...
    if (item?.seller?.id) {
      window.location.href = `/messages?seller=${item.seller.id}`;
    }
  };
        ...
        <div style={{ flex: 2, minWidth: 320 }}>
          ...
          <div style={{ display: 'flex', gap: 12, marginBottom: 18, flexWrap: 'wrap' }}>
            <button 
              ...
              style={{ minWidth: 140, padding: '10px 16px', background: '#924DAC', color: '#fff', border: 'none', borderRadius: 6, cursor: 'pointer', fontWeight: 600 }}
            >
              Chat with Seller
            </button>
            ...
            {item.type === 'bidding' && (
              <button 
                ...
                style={{ minWidth: 140, padding: '10px 16px', background: '#f39c12', color: '#fff', border: 'none', borderRadius: 6, cursor: 'pointer', fontWeight: 600 }}
              >
                Bid Now
              </button>
            )}
            ...
            {item.type === 'exchange' && (
              <button 
                ...
                style={{ minWidth: 140, padding: '10px 16px', background: '#3498db', color: '#fff', border: 'none', borderRadius: 6, cursor: 'pointer', fontWeight: 600 }}
              >
                Barter
              </button>
            )}
            ...
            {item.type === 'resell' && item.price && (
              <button 
                ...
                style={{ minWidth: 140, padding: '10px 16px', background: '#2ecc40', color: '#fff', border: 'none', borderRadius: 6, cursor: 'pointer', fontWeight: 600 }}
              >
                Buy Now
              </button>
            )}
          ...
          <div style={{ background: '#f7f7fa', borderRadius: 8, padding: '12px 18px', fontWeight: 600, color: '#388e3c', fontSize: 14 }}>
