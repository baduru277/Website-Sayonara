      ...
      case "notification":
        return (
          <div style={{ padding: 32 }}>
            ...
            <div style={{ background: "#fff7e6", borderRadius: 8, padding: 18, marginBottom: 14, color: "#b26a00", fontWeight: 500 }}>
      ...
      case "setting":
        return (
          <div style={{ padding: 32 }}>
            ...
            <div style={{ marginBottom: 16 }}>
              <label>Email:</label>
              <input type="text" value={userProfile?.email || ""} readOnly style={{ padding: 8, borderRadius: 6, border: "1px solid #ccc", marginLeft: 12 }} />
            </div>
            <button
              onClick={async () => {
