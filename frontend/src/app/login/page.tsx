...
export default function LoginPage() {
  // Switched back to 'tab' for simplicity and consistency with original code
    ...
    try {
      if (tab === "login") {
        ...
        setTimeout(() => {
          ...
          // Optionally pre-fill email after successful signup
          setEmail(email); 
        }, 3000);
      }
    } catch (error: any) {
  ...
  const changeTab = (newTab: "login" | "signup") => {
    if (!registrationComplete) {
      ...
      setErrorMsg(null);
      setSuccessMsg(null);
      // Only clear email if switching from login to signup
      if (newTab === "signup") {
        setEmail("");
      }
      setPassword("");
    ...
    <div style={{ 
      ...
      <div style={{ 
        ...
        <div style={{ 
          ...
          {["login", "signup"].map((type) => (
            <button
              ...
              onClick={() => changeTab(type as "login" | "signup")}
            >
        ...
        <div style={{ 
          ...
          {tab === "login" ? (
            <p>Don't have an account? <button onClick={() => changeTab("signup")} style={{ color: "#924DAC", background: "none", border: "none", cursor: "pointer", fontWeight: 600, textDecoration: "underline" }}>Sign up</button></p>
          ) : (
            <p>Already have an account? <button onClick={() => changeTab("login")} style={{ color: "#924DAC", background: "none", border: "none", cursor: "pointer", fontWeight: 600, textDecoration: "underline" }}>Log in</button></p>
          )}
        </div>
      </div>
